...
import { XCircle, AlertTriangle, UserPlus } from 'lucide-react';
        ...
        <div className="bg-slate-900 border border-rose-500/30 rounded-3xl p-6 sm:p-10 shadow-2xl space-y-6">
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6 text-left space-y-4">
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Como os dados não conferem, o cadastro anterior foi cancelado e a conta foi removida do sistema por segurança. Por favor, faça um novo cadastro com as informações e documentos corretos.
            </p>
            
            <Link
              href="/cadastro"
              className="w-full bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-500 hover:to-rose-400 text-white font-bold py-3.5 px-6 rounded-xl transition-all shadow-lg shadow-rose-600/25 flex items-center justify-center gap-2 text-xs sm:text-sm cursor-pointer text-center"
            >
